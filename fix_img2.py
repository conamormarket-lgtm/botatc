...
target_vid = """elif tipo == "video":
                    return f\"\"\"<div style="text-align:center;"><video controls src="{src_url}" style="max-width: 250px; border-radius: 8px; background: rgba(0,0,0,0.5); margin-bottom: 5px; display:inline-block;"></video></div>\"\"\""""
...
rep_vid = """elif tipo == "video":
                    return f\"\"\"<div style="text-align:center;"><video controls src="{src_url}" style="max-width: 100%; max-height: 400px; width: auto; object-fit: contain; border-radius: 8px; background: rgba(0,0,0,0.5); margin-bottom: 5px; display: block; margin: 0 auto;"></video></div>\"\"\""""
