        ...
        <script>
            ...
            function renderQuickReplies(data) {{
                ...
                data.forEach(qr => {{
                    ...
                    if(qr.category && qr.category !== qr.title) {{
                        const catBadge = document.createElement("span");
                        catBadge.innerText = qr.category;
                        catBadge.style.cssText = "font-size:0.62rem; background:rgba(255,255,255,0.09); padding:0.1rem 0.35rem; border-radius:3px; color:var(--text-muted);";
                    ...
                    // Message preview supporting new object format
