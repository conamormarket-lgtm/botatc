---
name: gotcha
description: "Gotcha for botatc. 1 error→fix pairs."
domain: gotcha
triggers:
  - glob: "**/*"
autoGenerated: true
...
Auto-compiled from **65 real patterns** in **botatc**. This skill is auto-routed to agents when working on gotcha files.
...
|-------|-----|------|
| `- - **⚠️ GOTCHA: Fixed null crash in Exception — p` | Patched security issue Score — evolves the database schema t | 2x |
...
- ✅ Avoid: ⚠️ GOTCHA: Added JWT tokens authentication (seen 10x)
- ✅ Avoid: ⚠️ GOTCHA: Fixed null crash in Request — parallelizes async operations for speed (seen 2x)

---
*Auto-generated by BrainSync 🧠 | 65 patterns | 2026-04-10*
