...
new_form = r"""<form onsubmit="window.enviarMensajeManual(event, '{wa_id}'); return false;" style="display:flex; gap:0.4rem; width:100%; margin:0; position:relative; align-items:flex-end; box-sizing:border-box; max-width:100%;">
...
print("Moved emoji button to pill and optimized sizing")
